			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-primary">
						<!-- form start -->
						<form class="form-horizontal" action="<?php echo e(route('affidavit.update', $LoggedUserInfo->id)); ?> " method="POST" >
							<?php echo csrf_field(); ?> 
...
unset($__errorArgs, $__bag); ?></span>
										<input type="text" class="form-control" name="income_tax" id="exampleInputEmail1" value="<?php echo e($affidavit->income_tax); ?>">
									</div>
									<div class="col-md-4">
...
unset($__errorArgs, $__bag); ?></span>
										<input type="text" class="form-control" name="vat_no" id="exampleInputEmail1" value="<?php echo e($affidavit->vat_no); ?>">
									</div>
									<div class="col-md-4">
							...
							<div class="card-footer">
								...
								<a href="<?php echo e(route('affidavit.show')); ?>" class="btn btn-default"><i class="fas fa-eye"></i> View</a>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CABB_Vendor_Management\resources\views/admin/affidavit/edit.blade.php ENDPATH**/ ?>