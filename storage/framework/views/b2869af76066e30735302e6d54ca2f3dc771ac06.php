...
<head>
	...
	<title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(Project_name); ?> </title>
...
<body class="hold-transition sidebar-mini layout-fixed">
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="#" class="brand-link">
    ...
    <span class="brand-text font-weight-light"><?php echo e(Project_name); ?>  </span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?php echo e(url('public/images/users', $LoggedUserInfo->image)); ?>" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
       <a href="<?php echo e(route('profile.index')); ?>" class="d-block">
...
<nav class="mt-2">
 <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- 	<li class="nav-item menu-open">
           ...
           <li class="nav-item">
             <a href="<?php echo e(route('affidavit.create')); ?>" class="nav-link">
           ...
           <li class="nav-item">
             <a href="<?php echo e(route('affidavit.show')); ?>" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
               show
             </p>
         ...
         <li class="nav-item">
           <a href="<?php echo e(route('application_form')); ?>" class="nav-link">
       ...
       <li class="nav-item">
         <a href="<?php echo e(route('class_app.create')); ?>" class="nav-link">
      ...
      <li class="nav-item">
       <a href="<?php echo e(route('renewal.create')); ?>" class="nav-link">
...
<?php /**PATH C:\xampp\htdocs\caab\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>